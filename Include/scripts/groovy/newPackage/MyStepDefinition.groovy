...
class MyStepDefinition {
	...
	def I_enter_valid_username_password(String username, String password) {
		...
		WebUI.setText(findTestObject('Object Repository/Log in/input_Username_username'), username)
		WebUI.setText(findTestObject('Object Repository/Log in/input_Password_password'), password)
	}
