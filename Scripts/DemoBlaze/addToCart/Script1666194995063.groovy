...
x = WebUI.getText(findTestObject('Object Repository/Page_STORE/a_Samsung galaxy s6'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_STORE/td_Samsung galaxy s6'), x)
